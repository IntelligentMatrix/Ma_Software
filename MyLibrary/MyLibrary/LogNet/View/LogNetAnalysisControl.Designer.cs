namespace MyLibrary.LogNet
{
    partial class LogNetAnalysisControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.userButton_source = new MyControl.UserButton();
            this.userButton_All = new MyControl.UserButton();
            this.userButton_Fatal = new MyControl.UserButton();
            this.userButton_Error = new MyControl.UserButton();
            this.userButton_Warn = new MyControl.UserButton();
            this.userButton_Info = new MyControl.UserButton();
            this.userButton_Debug = new MyControl.UserButton();
        ...
        private MyLibrary.MyControl.UserButton userButton_Debug;
        private MyLibrary.MyControl.UserButton userButton_Info;
        private MyLibrary.MyControl.UserButton userButton_Warn;
        private MyLibrary.MyControl.UserButton userButton_Error;
        private MyLibrary.MyControl.UserButton userButton_Fatal;
        private MyLibrary.MyControl.UserButton userButton_All;
        private System.Windows.Forms.Label label2;
        private MyLibrary.MyControl.UserButton userButton_source;
