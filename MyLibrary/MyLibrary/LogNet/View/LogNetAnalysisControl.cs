...
namespace MyLibrary.LogNet
{
    ...
    public partial class LogNetAnalysisControl : UserControl
    {
        ...
        private MyLibrary.MyControl.UserButton selectButton = null;

        private void UserButtonSetSelected(MyLibrary.MyControl.UserButton userButton)
        {
